...
let $editor = (() => {
  ...
  let search = (srch) => {
    ...
    if (!srch.capitalSense) { // 不区分大小写，把所有字符串都换成小写
  ...
  return { show, resize, focus, getTotalLn, getRow, getCol, getContent, setContent, setWrap, newFile, selectAll, insertDataTime, gotoLn, bingSearch, search, setFont };
})();
